...
module.exports = {
  ...
  steps: {
    ...
    "/reports": {
      backLink: false,
      behaviours: [fullWidth, resumeSession],
      next: "/reference",
    },
    "/are-you-sure": {
      backLink: false,
    ...
    "/pv-under-age": {
      behaviours: [automaticReferral, resetJourneyToSubmitNRM, saveFormSession],
      fields: ["pv-under-age"],
    ...
    "/where-exploitation-happened-uk": {
      behaviours: [whereExploitationHappenedUk, saveFormSession],
      fields: [
      ...
      forks: [
        {
          target: "/where-exploitation-happened-overseas",
          condition: (req) =>
            req.sessionModel.get("where-exploitation-happened") ===
            "uk-and-overseas",
        },
      ],
    },
    ...
    "/types-of-exploitation": {
      behaviours: [typesOfExploitation, saveFormSession],
      fields: [
    ...
    "/pv-want-to-submit-nrm": {
      behaviours: [setReferralState, resetJourneyToSubmitNRM, saveFormSession],
    ...
    "/pv-name-dtn": {
      template: "pv-name",
      behaviours: [saveFormSession],
      fields: ["pv-name-first-name", "pv-name-last-name", "pv-name-nickname"],
      ...
      forks: [
        {
          target: "/someone-else",
          condition: (req) =>
            req.sessionModel.get("who-contact") === "someone-else",
        },
      ],
      continueOnEdit: true,
    },
      ...
      forks: [
        {
          target: "/fr-details",
          condition: (req) =>
            req.sessionModel.get("does-pv-need-support") === "no",
        },
      ],
    },
