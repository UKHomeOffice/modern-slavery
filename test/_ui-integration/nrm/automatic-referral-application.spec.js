...
describe('the journey of a nrm automatic referral application', () => {
  ...
  it('goes to the potential-victim-exploitative-situation-multiple page when user enters their background', async () => {
    ...
    expect(response.text).to.contain('Found. Redirecting to /nrm/potential-victim-exploitative-situation-multiple');
  });

  it('goes to the when-did-the-exploitation-take-place page when user selects no', async () => {
    const URI = '/potential-victim-exploitative-situation-multiple';
    await initSession(URI);
    const response = await passStep(URI, {
      'potential-victim-exploitative-situation-multiple': 'no'
    });
  ...
  it('goes to the where-how-interview-carried-out page when user enters modern-slavery-indicators', async () => {
    ...
    await initSession(URI);
    const response = await passStep(URI, {
      'modern-slavery-indicators': 'no'
    });

    expect(response.text).to.contain('Found. Redirecting to /nrm/where-how-interview-carried-out');
  });

  it('goes to the rofessional-insight page when user enters where and how the interview was carried out',
    async () => {
  ...
  it('goes to the where-exploitation-happened page when user selects others were involved and enter details', async () => {
  ...
  it('redirects to the upload-evidence page when user uploads a file', async () => {
    const URI = '/upload-evidence';
    await initSession(URI);
  ...
  it('goes to the what-evidence-you-will-submit when files have been uploaded', async () => {
    const URI = '/upload-evidence';
    await initSession(URI);
  ...
  it('goes to the confirm page when user enters evidence details', async () => {
