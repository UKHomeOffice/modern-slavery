...
describe('the journey of a nrm application', () => {
  ...
  it('goes to the professional-insight page when user enters where and how the interview was carried out',
    async () => {
  ...
  it('goes to the are-others-involved page when user selects others were involved and enter details', async () => {
