...
module.exports = {
  ...
  selectors: {
    ...
    PV_NAME_REQUIRING_SUPPORT_LAST_NAME: '#pv-name-that-requires-support-last-name',
    ...
    REFUSE_NRM_POLICE_CONTACT_YES_OPTION: '#refuse-nrm-co-operate-with-police-yes',
    REFUSE_NRM_PV_NAME_FIRST_NAME: '#refuse-nrm-pv-name-first-name',
    REFUSE_NRM_PV_NAME_LAST_NAME: '#refuse-nrm-pv-name-last-name',
