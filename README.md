...
```bash
$ docker exec -i -t modern-slavery_app_1 /bin/bash
```
...
These acceptance scripts will currently test 1 aspect of the upload functionality; a single file upload.
The location of all the tests will be in the directory: `/modern-slavery/acceptance-test/user-pathways/upload-files/upload-files.test.js`
